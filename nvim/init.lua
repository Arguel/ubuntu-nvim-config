...
-- Hlslens 
require('hlslensP.settings')

-- Lualine 
require('lualineP.settings')

-- Telescope
require('telescopeP.settings')

-- Nvim-tree
require('nvimtreeP.settings')

-- Colorscheme
require('colorschemeP.settings')
